...
Main subject: A hand holding the badge`,
    ...
    {
        id: 'f2-style-11',
        name: 'CASE 140: PS2 게임 커버 (GTA x 조선왕조)',
        description: '조선시대를 배경으로 한 가상의 PS2용 GTA 게임 "Grand Theft Auto: Joseon"의 커버를 생성합니다.',
        prompt: `Can you create a PS2 video game case of "Grand Theft Auto: Joseon" a GTA based in the Korean Joseon Dynasty.`,
        imageUploads: 0,
        suggestionHint: '다른 게임과 다른 세계관을 조합하여 새로운 게임 커버를 만들어보세요.',
        author: '@dotey',
        href: 'https://github.com/JimmyLv/awesome-nano-banana#cases-11',
    },
    {
        id: 'f2-style-5',
        name: 'CASE 141: 한국 애니메이션 스타일',
        description: '업로드한 사진을 한국 애니메이션 스타일로 다시 그립니다.',
        prompt: `Redraw this photo in a popular Korean animation style`,
        imageUploads: 1,
        suggestionHint: '특정 한국 애니메이션 작품의 스타일을 지정해보세요 (예: 신비아파트, 뽀로로 스타일).',
        author: 'AnimeAI',
        href: 'https://github.com/JimmyLv/awesome-nano-banana#cases-5',
    },
    {
        id: 'f2-style-2',
        name: 'CASE 142: 3D 폴라로이드 브레이크아웃 효과',
        description: '인물 사진을 3D 꼬마 피규어로 변환하여 폴라로이드 사진 프레임을 뚫고 나오는 듯한 효과를 연출합니다.',
        ...
        imageUploads: 1,
        suggestionHint: '캐릭터가 다른 프레임에서 튀어나오도록 요청하세요 (예: TV 화면, 책 페이지).',
        author: '@dotey',
        href: 'https://github.com/JimmyLv/awesome-nano-banana#cases-2',
    },
  ],
};
